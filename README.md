...
| **soca-dashboard** | 8080 | Edge device | Camera/schedule/rule management UI, edge config |
| **soca-service** | 8010 | Server | Alert consumer microservice (Redis only) |
